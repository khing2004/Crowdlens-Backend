    ...
    public static void Seed(CrowdLensDbContext context)
    {
        ...
        var locations = new List<Location>
        {
            ...
            new Location
            {
                ...
                Longitude    = 123.8953,
                LastUpdated  = DateTime.Now,
                VotesVeryLow = 1, VotesLow = 3, VotesMedium = 8, VotesHigh = 22, VotesVeryHigh = 18,
            },
            new Location
            {
                LocationName = "Cebu Normal University",
                Type         = "University",
                Capacity     = 3000,
                UserCount    = 1800,
                Latitude     = 10.2985,
                Longitude    = 123.8940,
                LastUpdated  = DateTime.Now,
                VotesVeryLow = 2, VotesLow = 5, VotesMedium = 10, VotesHigh = 18, VotesVeryHigh = 12,
            },

            // ── Hospitals (additional) ───────────────────────────────────────────
            new Location
            {
                LocationName = "Chong Hua Hospital",
                Type         = "Hospital",
                Capacity     = 800,
                UserCount    = 600,
                Latitude     = 10.3170,
                Longitude    = 123.8962,
                LastUpdated  = DateTime.Now,
                VotesVeryLow = 0, VotesLow = 2, VotesMedium = 6, VotesHigh = 18, VotesVeryHigh = 20,
            },
            new Location
            {
            ...
            new Location
            {
                ...
                Longitude    = 123.8997,
                LastUpdated  = DateTime.Now,
                VotesVeryLow = 2, VotesLow = 6, VotesMedium = 14, VotesHigh = 16, VotesVeryHigh = 8,
            },
        };

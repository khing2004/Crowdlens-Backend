...
namespace Crowdlens_backend.Migrations
{
    ...
    [Migration("20260517134407_UpdateLocationCoordinates")]
    partial class UpdateLocationCoordinates
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Crowdlens_backend.Models.Location", b =>
                {
                    ...
                    b.Property<int>("VotesHigh")
                        .HasColumnType("INTEGER");

                    b.Property<int>("VotesLow")
                        .HasColumnType("INTEGER");

                    b.Property<int>("VotesMedium")
                        .HasColumnType("INTEGER");

                    b.Property<int>("VotesVeryHigh")
                        .HasColumnType("INTEGER");

                    b.Property<int>("VotesVeryLow")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Crowdlens_backend.Models.Report", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Crowdlens_backend.Models.ReportVote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Crowdlens_backend.Models.ReportVote", b =>
                {
                    b.HasOne("Crowdlens_backend.Models.Report", "Report")
                        .WithMany("Votes")
